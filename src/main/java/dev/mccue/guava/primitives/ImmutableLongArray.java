...
/**
 * An immutable array of {@code long} values, with an API resembling {@code List}.
 *
 ...
 *       hunt through classes like {@code Arrays} and {@code Longs} for them.
 ...
 * </ul>
 *
 * <p>Advantages compared to {@code dev.mccue.guava.collect.ImmutableList ImmutableList}{@code
 * <Long>}:
 *
 * <ul>
 *   <li>Improved memory compactness and locality.
 *   <li>Can be queried without allocating garbage.
 *   <li>Access to {@code LongStream} features (like {@code LongStream#sum}) using {@code stream()}
...
public final class ImmutableLongArray implements Serializable {
  ...
  /**
   * Returns a new, empty builder for {@code ImmutableLongArray} instances, sized to hold up to
  ...
  /**
   * Returns a new, empty builder for {@code ImmutableLongArray} instances, with a default initial
   * capacity. The returned builder is not thread-safe.
   *
   * <p><b>Performance note:</b> The {@code ImmutableLongArray} that is built will very likely
  ...
  /**
   * A builder for {@code ImmutableLongArray} instances; obtained using {@code
  ...
  public static final class Builder {
    ...
    /**
     * Appends {@code value} to the end of the values the built {@code ImmutableLongArray} will
     * contain.
     */
   ...
   * long} values are boxed into {@code Long} instances on demand, which can be very expensive. The
   * returned list should be used once and discarded. For any usages beyond that, pass the returned
   * list to {@code dev.mccue.guava.collect.ImmutableList#copyOf(Collection) ImmutableList.copyOf}
